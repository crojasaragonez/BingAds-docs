...
To get started developing Bing Ads applications with a .NET language, you can start with the [provided examples](/bingads/guides/code-examples) or follow one of the application walkthroughs for a [Web](/bingads/guides/walkthrough-web-application-csharp) or [Desktop](/bingads/guides/walkthrough-desktop-application-csharp) application. The examples have been developed with the Bing Ads .NET [SDK](/bingads/guides/client-libraries) and [Visual Studio Community](https://www.visualstudio.com/vs/community/). Your custom configuration may vary.
...
> 
> -   *Microsoft.BingAds.dll* - The Bing Ads .NET [SDK](/bingads/guides/client-libraries)
...
Once you have the Bing Ads .NET SDK installed, you can either browse the [Bing Ads Code Examples](/bingads/guides/code-examples) in C# or follow one of the application walkthroughs for a [Web](/bingads/guides/walkthrough-web-application-csharp) or [Desktop](/bingads/guides/walkthrough-desktop-application-csharp) application.
