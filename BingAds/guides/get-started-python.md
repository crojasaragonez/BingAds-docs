...
To get started developing Bing Ads applications with Python, you can start with the [provided examples](/bingads/guides/code-examples) or follow one of the application walkthroughs for a [Web](/bingads/guides/walkthrough-web-application-python) or [Desktop](/bingads/guides/walkthrough-desktop-application-python) application. The examples have been developed with the Bing Ads Python [SDK](/bingads/guides/client-libraries) and run with [Python Tools for Visual Studio (PTVS)](http://pytools.codeplex.com/) on [Visual Studio Community](https://www.visualstudio.com/vs/community/). Your custom configuration may vary.
...
The Bing Ads Python [SDK](/bingads/guides/client-libraries) supports Python 2.6, 2.7, 3.3, and 3.4. You should install and run one of the supported versions.

## <a name="installation"></a>Install the SDK
To install the Bing Ads Python [SDK](/bingads/guides/client-libraries) for the first time, run the following either from your IDE or command line prompt.
...
Once you have the Bing Ads Python [SDK](/bingads/guides/client-libraries) installed, you can either download the examples from [GitHub](https://github.com/BingAds/BingAds-Python-SDK) or follow one of the application walkthroughs for a [Walkthrough: Bing Ads Web Application in Python](/bingads/guides/walkthrough-web-application-python) or [Walkthrough: Bing Ads Desktop Application in Python](/bingads/guides/walkthrough-desktop-application-python) application.
...
-   For derived types such as [ExpandedTextAd](/binga/bingads/campaign-management-service/expandedtextad), [NegativeKeyword](/binga/bingads/campaign-management-service/negativekeyword), and [NegativeKeywordList](/binga/bingads/campaign-management-service/negativekeywordlist), the Suds library requires that you use factory.create.
...
-   Any non-primitive elements must be specified for the Suds client e.g. *EditorialStatus* of type [AdEditorialStatus](/binga/bingads/campaign-management-service/adeditorialstatus), even though the Bing Ads services do not require such elements.
...
To call the corresponding methods of a Bing Ads service, you can use an instance of the *ServiceClient* class and pass the Suds factory object. For more information, see [Authentication With the SDKs](/bingads/guides/sdk-authentication#oauth).
